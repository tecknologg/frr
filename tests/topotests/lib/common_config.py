...
def load_config_to_router(tgen, routerName, save_bkup=False):
    ...
    * `save_bkup` : If True, Saves snapshot of FRRCFG_FILE to FRRCFG_BKUP_FILE
    ...
    for rname in ROUTER_LIST:
        ...
        try:
            frr_cfg_file = "{}/{}/{}".format(tgen.logdir, rname, FRRCFG_FILE)
            frr_cfg_save_file = "{}/{}/{}-{}".format(tgen.logdir, rname, gen, FRRCFG_FILE)
            frr_cfg_bkup = "{}/{}/{}".format(tgen.logdir, rname, FRRCFG_BKUP_FILE)
