...
def test_rib_ipv4_step2():
    ...
    tgen.net['rt8'].cmd('vtysh -c "conf t" -c "mpls ldp" -c "address-family ipv4" -c "no discovery targeted-hello accept"')
...
def test_rib_ipv4_step3():
    ...
    tgen.net['rt8'].cmd('vtysh -c "conf t" -c "mpls ldp" -c "address-family ipv4" -c "discovery targeted-hello accept"')
...
def test_rib_ipv4_step4():
    ...
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "interface eth-rt2" -c "no isis fast-reroute remote-lfa tunnel mpls-ldp"')
...
def test_rib_ipv4_step5():
    ...
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "interface eth-rt3" -c "no isis fast-reroute remote-lfa tunnel mpls-ldp"')
...
def test_rib_ipv4_step6():
    ...
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "interface eth-rt2" -c "isis fast-reroute remote-lfa tunnel mpls-ldp"')
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "interface eth-rt3" -c "isis fast-reroute remote-lfa tunnel mpls-ldp"')
...
def test_rib_ipv4_step7():
    ...
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "router isis 1" -c "fast-reroute remote-lfa prefix-list PLIST"')
...
def test_rib_ipv4_step8():
    ...
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "ip prefix-list PLIST seq 5 permit 10.0.255.8/32"')
...
def test_rib_ipv4_step9():
    ...
    logger.info('Changing the maximum metric up to the PQ node to 30 on the eth-rt2 interface')
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "interface eth-rt2" -c "isis fast-reroute remote-lfa maximum-metric 30"')
...
def test_rib_ipv4_step10():
    ...
    logger.info('Changing the maximum metric up to the PQ node to 40 on the eth-rt2 interface')
    tgen.net['rt1'].cmd('vtysh -c "conf t" -c "interface eth-rt2" -c "isis fast-reroute remote-lfa maximum-metric 40"')

    for rname in ['rt1']:
        router_compare_json_output(rname, "show ip route isis json",
                                   outputs[rname][10]["show_ip_route.ref"])
